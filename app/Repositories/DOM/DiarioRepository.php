...
class DiarioRepository
{
    ...
    {   $today = now()->format('Y-m-d');
        return Http::get("http://www.dom.salvador.ba.gov.br/index.php?filterDateFrom=2001-09-01&filterDateTo=$today&option=com_dmarticlesfilter&view=articles&Itemid=3&userSearch=1&limstart=0&limitstart=$limstart");
    }
