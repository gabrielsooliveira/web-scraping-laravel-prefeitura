...
<div class="container">
    <div class="d-flex align-items-center justify-content-between">
        ...
        <button type="button" class="btn btn-primary btn-sm mt-5" data-bs-toggle="modal" data-bs-target="#processoAddModal">
           + Adicionar Processo
        </button>
    </div>
        ...
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-warning" href="{{ route("show_processos", $processo['id']) }}">Editar</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
